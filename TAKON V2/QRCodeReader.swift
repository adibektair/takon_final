...
public class QRCodeReader: NSObject, AVCaptureMetadataOutputObjectsDelegate {
     ...
     */
    public func startScanning(view: UIView, _ finishedScan: @escaping FinishedScan) throws {
        ...
        /* cancelButton = UIButton(frame: CGRect(x: cancelButtonMargin, y: view.frame.height - (cancelButtonHeight + cancelButtonMargin), width: view.frame.width - (2 * cancelButtonMargin), height: cancelButtonHeight))
